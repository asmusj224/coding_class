...
title = canvas.create_text(200, 200, text = game_title, fill = 'green', font = ('helvetica', 20))
directions = canvas.create_text(200, 300, text =' collect candy but aviod read ones.', fill = 'green', font = ('helvetica', 20))
...
#character
image_file = "Desktop/joshuacoding/spongebob.gif"
...
bad_candy_list = []
candy_speed = 2
candy_colors_list = ["blue", "green", "pink","red", "yellow", "purple", "white"]

def make_candy():
    xpostion = random.randint(1, 400)
